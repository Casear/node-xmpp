...
function Client(opts) {
    ...
    if(opts.availableSaslMechanisms&& Array.isArray(opts.availableSaslMechanisms)){
        this.availableSaslMechanisms=opts.availableSaslMechanisms;
    }
    if(opts.preferredSaslMechanism){
        this.preferredSaslMechanism = opts.preferredSaslMechanism;
    }
    if (opts.credentials) {
        this.preferredSaslMechanism = 'EXTERNAL';
        this.availableSaslMechanisms.push('EXTERNAL');
    }
